...
#Class holds information for type of product Journal, parent class is Product
class Journal(Product):
    ...
    #Initailze the instance of Journal with its parent class to inherit its methods
    def __sup(self):
        super(Journal, self).__init__(self.__productId, type(self), self.author, self.title, self.stock, self.avstock)
