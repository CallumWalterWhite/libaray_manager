...
#Class holds information for type of product CD, parent class is Product
class CD(Product):
    ...
    #Initailze the instance of CD with its parent class to inherit its methods
    def __sup(self):
        super(CD, self).__init__(self.__productId, type(self), self.author, self.title, self.stock, self.avstock)
